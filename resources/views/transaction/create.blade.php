...
<div class="col-lg-8">
    ...
    <form method="post" action="{{ route('store-customer') }}" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tanggal_keluar') is-invalid @enderror" id="tanggal_keluar" name="tanggal_keluar" required value="{{ old('tanggal_keluar') }}">
